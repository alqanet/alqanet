...
<!-- ===== TOP BANNER ===== -->
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=00FFAA&height=200&section=header&text=🎮%20ALQANET%20🎮&fontSize=50&fontColor=FFFFFF&animation=twinkling" width="100%" />
</p>
  ...
  <tr>
    <td width="50%" valign="middle">
      ...
      <table style="background: #1a1a1a; border-radius: 30px; border: 2px dashed #00FFAA; padding: 20px;">
        <tr>
          <td>
            <h1 style="color: #00FFAA; font-size: 36px; margin: 0;">👋 HEY!</h1>
            <h2 style="color: #FFFFFF; font-size: 26px; margin: 5px 0;">I'm <span style="color: #00FFAA; font-weight: bold;">ALQANET</span></h2>
            <p style="color: #FFD93D; font-size: 16px;">
              <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="20px" /> 
              <strong>Full-Stack Developer</strong> | <strong>Tech Superhero</strong>
            </p>
            <p style="color: #AAAAAA; font-size: 15px;">
              🚀 Building ALQANET - Qatar's Manpower Platform<br>
    ...
    <td width="50%" align="center">
      <img src="https://media.giphy.com/media/qgQUggAC3Pfv687qPC/giphy.gif" width="300" height="180" style="border-radius: 30px; border: 3px solid #00FFAA;" />
      <br><br>
      <img src="https://media.giphy.com/media/du3J3cXyzhj75IOgvA/giphy.gif" width="80" style="border-radius: 20px;" />
    </td>
  </tr>
</table>
...
<table align="center" style="border: 5px solid #00FFAA; border-radius: 40px; background: #0a0a0a; width: 90%;">
  <tr>
    <td align="center" style="padding: 30px;">
      ...
      <h1 style="color: #00FFAA; font-size: 46px; margin: 0;">🚀 ALQANET</h1>
      <p style="color: #FFD93D; font-size: 18px;">THE ULTIMATE MANPOWER PLATFORM</p>
      ...
      <table style="background: #1a1a1a; border-radius: 20px; border: 2px dashed #FFD93D; width: 100%;">
        <tr>
          <td align="center" style="padding: 15px;">
            <p style="color: #00FFAA; font-size: 22px; font-weight: bold;">🎯 MISSION</p>
            <p style="color: #FFFFFF; font-size: 16px;">Connect Qatar Manpower Companies with Global Talent</p>
            <p style="color: #FFD93D; font-size: 24px;">✨</p>
            <p style="color: #00FFAA; font-size: 18px;">
      ...
      <!-- Tech Stack -->
      <p style="color: #FFFFFF; font-size: 18px; font-weight: bold;">🛠️ POWER-UPS</p>
      <p>
      ...
      <table align="center" style="background: #1a1a1a; border-radius: 20px; border: 2px solid #00FFAA;">
        <tr>
          <td align="center" style="padding: 8px 15px;">
            <p style="color: #00FFAA; font-size: 13px;">✅ Company Registration</p>
          </td>
          <td align="center" style="padding: 8px 15px;">
            <p style="color: #FFD93D; font-size: 13px;">✅ Admin Approval</p>
          </td>
          <td align="center" style="padding: 8px 15px;">
            <p style="color: #FF6B6B; font-size: 13px;">✅ Email Verification</p>
          </td>
        </tr>
        <tr>
          <td align="center" style="padding: 8px 15px;">
            <p style="color: #00FFAA; font-size: 13px;">✅ CV Upload</p>
          </td>
          <td align="center" style="padding: 8px 15px;">
            <p style="color: #FFD93D; font-size: 13px;">✅ Google Login</p>
          </td>
          <td align="center" style="padding: 8px 15px;">
            <p style="color: #FF6B6B; font-size: 13px;">✅ Plans Management</p>
          </td>
        </tr>
      </table>
      ...
      <!-- Progress Bars -->
      <br>
      <p style="color: #FFFFFF; font-size: 15px;">📈 LEVEL PROGRESS</p>
      <p>
        <img src="https://progress-bar.dev/80/?title=Backend&width=200&color=00FFAA" />
        <img src="https://progress-bar.dev/60/?title=Frontend&width=200&color=FFD93D" />
        <br>
        <img src="https://progress-bar.dev/40/?title=Testing&width=200&color=FF6B6B" />
        <img src="https://progress-bar.dev/50/?title=Deployment&width=200&color=00FFAA" />
      </p>
...
<p align="center">
  <img src="https://img.shields.io/badge/CONNECT-WITH%20ME-00FFAA?style=for-the-badge&logo=github&logoColor=white" />
</p>
...
<details align="center">
  <summary style="font-size: 22px; color: #00FFAA; font-weight: bold;">
    🎮 CLICK FOR FUN FACTS
  </summary>
  <br>
...
<table align="center" style="border: 5px dashed #00FFAA; border-radius: 40px; background: #0a0a0a; width: 95%;">
  <tr>
    <td align="center" colspan="2" style="padding: 20px;">
      <img src="https://media.giphy.com/media/L1R1tvI9svkIWwpYqx/giphy.gif" width="250" style="border-radius: 30px; border: 3px solid #FFD93D;" />
      <img src="https://media.giphy.com/media/du3J3cXyzhj75IOgvA/giphy.gif" width="150" style="border-radius: 30px; border: 3px solid #FF6B6B;" />
    </td>
  </tr>
  <tr>
    <td align="center" width="50%" style="padding: 15px; border: 2px solid #00FFAA; border-radius: 20px;">
    ...
    <td align="center" width="50%" style="padding: 15px; border: 2px solid #FFD93D; border-radius: 20px;">
  ...
  <tr>
    <td align="center" width="50%" style="padding: 15px; border: 2px solid #FF6B6B; border-radius: 20px;">
    ...
    <td align="center" width="50%" style="padding: 15px; border: 2px solid #00FFAA; border-radius: 20px;">
      <h3 style="color: #00FFAA;">🎮 FREE TIME</h3>
      <p style="color: #FFFFFF; font-size: 15px;">
...
<p align="center">
  <img src="https://img.shields.io/badge/SUPPORT-MY%20WORK-FF6B6B?style=for-the-badge&logo=github&logoColor=white" />
</p>
...
<p align="center">
  <img src="https://media.giphy.com/media/3ov9k1173PdfJWRsoE/giphy.gif" width="40" />
  <br>
  <span style="color: #00FFAA; font-size: 16px; font-weight: bold;">
